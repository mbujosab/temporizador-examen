...
Puede consultar la [[https://mbujosab.github.io/temporizador-examen/temporizadores/Temporizador-demo.html][demostración en línea]] (presione =espacio= para iniciar el temporizador) o continúe leyendo para obtener más información sobre este recurso.
...
1. Antes de que lleguen los estudiantes, *abra =SuTemporizador.html= en un navegador*.
...
2. Una vez todo esté preparado, *presione la barra espaciadora* para iniciar el cronómetro.
...
* Creación de nuevos temporizadores

Revise el código de los archivos en [[https://github.com/mbujosab/temporizador-examen/tree/gh-pages/temporizadores][=temporizadores=]] o en el fichero con el código fuente [[https://github.com/mbujosab/temporizador-examen/blob/main/examtimer.org][examtimer.org]].
