...
1. Revise el código fuente en el archivo [[file:./examtimer.org][=examtimer.org=]] o directametne el temporizador de demostración [[file:Temporizador-demo.html][Mates2-demo.html]].
